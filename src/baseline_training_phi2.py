"""
Baseline (Flat-LoRA) training for Phi-2 2.7B.
Same data as the progressive model, but WITHOUT 4-phase curriculum, WITHOUT pruning.
All data mixed together, single training phase — the control group.
"""
...
def train_baseline():
    print("=" * 60)
    print("  BASELINE (Flat-LoRA) — Phi-2 2.7B (Microsoft)")
    ...
    repo_id = os.environ.get("HF_REPO_ID", "dexmac/progressive-cognitive-phi2-baseline-lora")
