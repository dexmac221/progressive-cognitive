...
SPACE_NAME = "progressive-cognitive-training"
USERNAME = "dexmac"
...
readme_content = f"""---
title: Progressive Cognitive Training
emoji: 🧠
colorFrom: blue
colorTo: purple
sdk: docker
...
# Progressive Cognitive Architecture Training

This Space runs the training of the progressive cognitive model.
"""
...
try:
    ...
    api.upload_file(
        path_or_fileobj="progressive_llm_cognitive_hf.py",
...
try:
    ...
    api.add_space_secret(repo_id=REPO_ID, key="HF_REPO_ID", value=f"{USERNAME}/progressive-cognitive-lora")
    print("Secrets added successfully.")
except Exception as e:
    print(f"Error adding secrets: {e}")

print("\nDone! The model will be trained and saved in the repository:")
print(f"https://huggingface.co/{USERNAME}/progressive-cognitive-lora")
