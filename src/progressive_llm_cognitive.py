...
class Config:
    ...
    # LoRA — parametri trainabili ridotti (~0.5M vs 82M)
    lora_r = 8               # rango della decomposizione
    lora_alpha = 16
    lora_dropout = 0.05
...
╔══════════════════════════════════════════════════════════════╗
║    ARCHITETTURA COGNITIVA PROGRESSIVA — LLM Edition         ║
║    distilgpt2 (82M) + LoRA + Pruning Progressivo            ║
╚══════════════════════════════════════════════════════════════╝"""
  ...
  Architettura:
    Modello base:           distilgpt2 (82M parametri, congelati)
  ...
  ╔════════════════════════════════════════════════════════════╗
  ║  L'82M di distilgpt2 sono la 'memoria a lungo termine'    ║
  ...
  ╚════════════════════════════════════════════════════════════╝
    ...
    def _save_everything(self):
        out_dir = '/home/claude/output_llm'
